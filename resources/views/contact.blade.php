...
<body class="inner-page">
    ...
    <main>
        <section class="inner-hero">
            <img class="inner-hero-bg" src="{{ asset('images/hero/container-shipping.png') }}" alt="Container logistics support">
            <div class="container">
                <span class="section-kicker">Contact Us</span>
                <h1>Need dependable logistics coordination?</h1>
            ...
            <div class="container">
                <div class="contact-panel animate-on-scroll">
                    <div>
                        ...
                        <h2>Let us support your next cargo movement.</h2>
                        <p>Send your request and our team will help with the right freight, shipping, documentation, and supply chain direction.</p>
                    </div>
                    <div class="contact-actions">
                        <a class="contact-method" href="mailto:info@lexondynamic.com">
                            <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M4 6h16v12H4z" /><path d="M4 8l8 6 8-6" /></svg>
                            <span>info@lexondynamic.com</span>
                        </a>
                        <a class="contact-method" href="tel:+2349028384220">
                            <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M6 4h4l2 5-3 2a12 12 0 0 0 4 4l2-3 5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 4 6a2 2 0 0 1 2-2z" /></svg>
                            <span>+234 902 838 4220</span>
                        </a>
                        <a class="contact-method" href="tel:+19052264683">
                            <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M6 4h4l2 5-3 2a12 12 0 0 0 4 4l2-3 5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 4 6a2 2 0 0 1 2-2z" /></svg>
                            <span>+1 (905) 226-4683</span>
                        </a>
                    </div>
                </div>
            </div>
