            ...
            <div class="container">
                <div class="row g-5 align-items-start">
                    ...
                    <div class="col-lg-8 animate-on-scroll animate-from-right">
                        <div class="why-list">
                            @foreach ([
                                ['Reliable international freight solutions', 'M3 7h11v8H3zM14 10h4l3 3v2h-7zM7 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM18 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4z'],
                                ['Expertise in container shipping and heavy equipment logistics', 'M4 7h16v10H4zM8 7v10M12 7v10M16 7v10M6 4h12M7 20h10'],
                                ['Professional vehicle and auto transportation services', 'M4 14l2-5h10l3 5M5 14h14v4H5zM7 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM17 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4z'],
                                ['Safe and timely cargo delivery', 'M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7zM8.5 12l2.2 2.2 4.8-5'],
                                ['Cross-border and global shipping capabilities', 'M3 12h18M12 3c2.4 2.6 3.6 5.6 3.6 9S14.4 18.4 12 21M12 3c-2.4 2.6-3.6 5.6-3.6 9S9.6 18.4 12 21'],
                                ['Professional customs and documentation support', 'M7 3h8l4 4v14H7zM15 3v5h5M10 13h7M10 17h5'],
                                ['Efficient supply chain management', 'M4 7l8-4 8 4-8 4zM4 12l8 4 8-4M4 17l8 4 8-4'],
                                ['Customer-focused logistics solutions', 'M8 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM16 21a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM12 7h4a4 4 0 0 1 4 4v1M12 17H8a4 4 0 0 1-4-4v-1'],
                                ['Strong industry partnerships and operational expertise', 'M8 12l3 3 5-6M4.8 17.4L3 22l4.6-1.8M19.2 17.4L21 22l-4.6-1.8'],
                            ] as [$title, $path])
                    ...
                    <div class="col-lg-7">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6 animate-on-scroll">
                                <div class="region-card">
                                    <span class="region-icon">
                                        <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M4 5h16v12H4zM4 9h16M4 13h16M4 5h7v6H4z" /></svg>
                                    </span>
                                    <h3>United States</h3>
                            ...
                            <div class="col-sm-6 animate-on-scroll">
                                <div class="region-card">
                                    <span class="region-icon">
                                        <svg aria-hidden="true" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c2.4 2.6 3.6 5.6 3.6 9S14.4 18.4 12 21M12 3c-2.4 2.6-3.6 5.6-3.6 9S9.6 18.4 12 21" /></svg>
                                    </span>
                ...
                <div class="row g-4 align-items-stretch">
                    ...
                    <div class="col-lg-7 animate-on-scroll">
                        <div class="industry-cloud">
                            ...
                            <span><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M4 15l2-7h12l2 7M3 15h18M6 18c1.2 1 2.8 1 4 0 1.2 1 2.8 1 4 0 1.2 1 2.8 1 4 0" /></svg>Marine & Offshore</span>
                            <span><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M4 14l2-5h10l3 5M5 14h14v4H5zM7 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4zM17 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" /></svg>Automotive</span>
